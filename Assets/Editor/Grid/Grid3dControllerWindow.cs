...
public class Grid3dControllerWindow : EditorWindow
{
    private SpatialGrid3d grid;
    private GUIStyle style;
    private Queries3d boxQ;

    [MenuItem("CustomTools/Grid3dController")]
    public static void OpenWindow()
    {
        var w = GetWindow<Grid3dControllerWindow>();
        w.Show();
    }
    ...
    private void OnEnable()
    {
        ...
        style.fontSize = 20;
        grid = FindObjectOfType<SpatialGrid3d>();
