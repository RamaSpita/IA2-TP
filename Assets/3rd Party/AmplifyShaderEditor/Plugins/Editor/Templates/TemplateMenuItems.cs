...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[ MenuItem( "Assets/Create/Amplify Shader/ASETemplateShaders/Sprites Default WO MainTex", false, 85 )]
		public static void ApplyTemplate6()
		{
			AmplifyShaderEditorWindow.CreateNewTemplateShader( "04379c98f25cb7641addf3e9a2193f7a" );
		}
	}
}
